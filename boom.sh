#!/bin/bash
clear
echo -e "\e[4;31m SANIKAVA Productions !!! \e[0m"
echo -e "\e[1;34m Presents \e[0m"
echo -e "\e[1;32m SANIKAVA \e[0m"
echo "Press Enter To Continue"
read a1
if [[ -s update.SANIKAVA ]];then
...
echo This Script Was Made By BHAWANI
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By BHAWANI'> call.xxx
